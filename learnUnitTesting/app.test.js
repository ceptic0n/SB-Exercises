...
describe("test shit on the fucking body", function(){
	...
	it("should test if an h1 exists", function(){
		const testSelector = document.querySelector(".color");
		expect(testSelector.innerText).toBe("eek!");
	});
